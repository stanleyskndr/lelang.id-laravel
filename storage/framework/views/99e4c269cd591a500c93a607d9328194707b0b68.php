        ...
        <div class="edit-shoes-detail-body">
            <form method="POST" action=" <?php echo e(route('update_shoes', $shoes->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="form-input">
                    <label for="name" class=""><?php echo e(__('New Name:')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($shoes->shoe_name); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-input">
                    <label for="price" class=""><?php echo e(__('New Price:')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="price" value="<?php echo e($shoes->shoe_price); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-input">
                    <label for="description" class=""><?php echo e(__('New Description:')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="description" value="<?php echo e($shoes->shoe_description); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-input-image">
                    <label for="image" class=""><?php echo e(__('New Image:')); ?></label>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Binus\Web Programming\Project Lab Web Prog\JustDuIt\resources\views/shoes/edit_shoes.blade.php ENDPATH**/ ?>