                        ...
                        <?php if(auth::check() && auth::user()->role == 0): ?>
                            ...
                            <?php if($distance <= 0): ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong>You can't place bid on ended auction item.</strong>
                                </span>
                            <?php else: ?>
                            ...
                            <?php if(auth::check() && auth::user()->role == 1): ?>
                                ...
                                <div class="close-bid">
                                    <form method="POST" action=" <?php echo e(route('destroy_shoes', $shoes->id)); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <button ><?php echo e(__('Delete Shoes')); ?> </button>
                                    </form>
                                </div>     
                            <?php endif; ?>           
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Binus\Semester 5\Web Programming\Kelas kecil\BP2\lelangid_final\resources\views/shoes/shoes_show.blade.php ENDPATH**/ ?>