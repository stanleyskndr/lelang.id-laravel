                            ...
                            <div class="shoes-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="shoes-price">
                                        <p>Rp<?php echo e($shoe->shoe_price); ?></p>
                                    </div>
                                    
                                    <div class="modify-shoes">                                      
                                        <div class="modify-shoes-buttons">
                                            <form action="/editShoes/<?php echo e($shoe->id); ?>">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Binus\Semester 5\Web Programming\Kelas kecil lab\PROJECT\JustDuIt\resources\views/home.blade.php ENDPATH**/ ?>