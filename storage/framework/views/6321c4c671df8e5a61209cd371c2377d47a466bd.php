        ...
        <div class="card p-4">
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action=" <?php echo e(route('update_pizza', $pizza->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>

                            <div class="form-group row">
                                <label for="name" class="col-md-3 col-form-label"><?php echo e(__('Pizza Name:')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="price" class="col-md-3 col-form-label"><?php echo e(__('Pizza Price:')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-md-3 col-form-label"><?php echo e(__('Pizza Description:')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-md-3 col-form-label"><?php echo e(__('Pizza Image:')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\phizza-hut\resources\views/pizza/edit_pizza.blade.php ENDPATH**/ ?>