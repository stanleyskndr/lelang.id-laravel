...
<?php $__env->startSection('nav-menu-guest'); ?>
    ...
    <?php if(Route::has('register')): ?>
        <li class="nav-item">
            <a class="current-page" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
        </li>
    <?php endif; ?>
    <li class="nav-item">
...
<div class="content-con">
    <div class="login-register-con">
        ...
        <div class="middle-title">
            <h1 class=""><?php echo e(__('Register')); ?></h1>
            <hr>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Binus\Semester 5\Web Programming\Kelas kecil lab\PROJECT\JustDuIt\resources\views/auth/register.blade.php ENDPATH**/ ?>