                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="male" name="gender" class="custom-control-input form-control @error('gender') is-invalid @enderror" value="Male">
                                <label class="custom-control-label" for="male">Male</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="female" name="gender" class="custom-control-input form-control @error('gender') is-invalid @enderror" value="Female">
